...
.config(function($stateProvider,$urlRouterProvider, $ionicConfigProvider){
  if (ionic.Platform.isAndroid()){
    ...
    $stateProvider
            ...
            .state('chatuser',{url:'/chatuser',params: { userDetailParam: null, groupDetailParam: null},cache: false,templateUrl:'client/templates/chatuser.html',controller:'chatuserCtrl'})
            ...
            .state('groupwiseuser',{url:'/groupwiseuser',params:{ blockDataParam: null},cache: false,templateUrl:'client/templates/groupwiseuser.html',controller:'groupwiseuserCtrl'})
            .state('editgroup',{url:'/editgroup', params:{blockDataParam: null},cache: false,templateUrl:'client/templates/editgroup.html',controller:'editgroupCtrl'})
            .state('addcontact',{url:'/addcontact', params:{blockIdParam: null},cache: false,templateUrl:'client/templates/addcontact.html',controller:'addcontactCtrl'})
